    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="auth">
                    <a href="#auth">Auth</a>
                                ...
                                <a href="#auth-POSTapi-login">Validar credenciales de usuario (login)</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="messages">
                    <a href="#messages">Messages</a>
                                ...
                                <a href="#messages-GETapi-messages">GET api/messages</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="messages-POSTapi-messages">
                                <a href="#messages-POSTapi-messages">POST api/messages</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="messages-GETapi-messages--id-">
                                <a href="#messages-GETapi-messages--id-">GET api/messages/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="messages-PUTapi-messages--id-">
                                <a href="#messages-PUTapi-messages--id-">PUT api/messages/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="messages-DELETEapi-messages--id-">
                                <a href="#messages-DELETEapi-messages--id-">DELETE api/messages/{id}</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="products">
                    <a href="#products">Products</a>
                                ...
                                <a href="#products-GETapi-products--id-">GET api/products/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="products-PUTapi-products--id-">
                                <a href="#products-PUTapi-products--id-">PUT api/products/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="products-DELETEapi-products--id-">
                                <a href="#products-DELETEapi-products--id-">DELETE api/products/{id}</a>
                            </li>
                                                                        </ul>
                            </ul>
                    <ul id="tocify-header-slides" class="tocify-header">
                <li class="tocify-item level-1" data-unique="slides">
                    <a href="#slides">Slides</a>
                </li>
                                    <ul id="tocify-subheader-slides" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="slides-GETapi-slides">
                                <a href="#slides-GETapi-slides">GET api/slides</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="slides-POSTapi-slides">
                                <a href="#slides-POSTapi-slides">POST api/slides</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="slides-GETapi-slides--id-">
                                <a href="#slides-GETapi-slides--id-">GET api/slides/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="slides-PUTapi-slides--id-">
                                <a href="#slides-PUTapi-slides--id-">PUT api/slides/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="slides-DELETEapi-slides--id-">
                                <a href="#slides-DELETEapi-slides--id-">DELETE api/slides/{id}</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="users">
                    <a href="#users">Users</a>
                                ...
                                <a href="#users-GETapi-users">Display a listing of the resource.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="users-POSTapi-users">
                                <a href="#users-POSTapi-users">Store a newly created resource in storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="users-GETapi-users--id-">
                                <a href="#users-GETapi-users--id-">Display the specified resource.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="users-PUTapi-users--id-">
                                <a href="#users-PUTapi-users--id-">Update the specified resource in storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="users-DELETEapi-users--id-">
                                <a href="#users-DELETEapi-users--id-">Remove the specified resource from storage.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>API REST de Fakunet para gestionar productos, marcas, categorías, mensajes y slides.</p>
<aside>
    <strong>Base URL</strong>: <code>http://127.0.0.1:8000</code>
</aside>
<pre><code>Bienvenido a la documentación de la API de Fakunet.
...
&lt;aside&gt;Ejemplos de código están disponibles y puedes cambiar el lenguaje con las pestañas superiores.&lt;/aside&gt;</code></pre>
...
<p>Usa Authorization: Bearer <token> para endpoints protegidos.</p>

        <h1 id="auth">Auth</h1>

    

                                <h2 id="auth-POSTapi-login">Validar credenciales de usuario (login)</h2>
...
<p>Example: <code>|]|{+-</code></p>
    ...
    <p>Endpoints para gestionar marcas. Requieren autenticación Bearer.</p>

                                <h2 id="brands-GETapi-brands">GET api/brands</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="brands-POSTapi-brands">POST api/brands</h2>
...
<p>Example: <code>false</code></p>
                    ...
                    <h2 id="brands-GETapi-brands--id-">GET api/brands/{id}</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://127.0.0.1:8000/api/brands/architecto" \
    --header "Authorization: Bearer Bearer {YOUR_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://127.0.0.1:8000/api/brands/architecto"
);
...
<p>The ID of the brand. Example: <code>architecto</code></p>
                    ...
                    <h2 id="brands-PUTapi-brands--id-">PUT api/brands/{id}</h2>
...
<p>Example: <code>true</code></p>
                    ...
                    <h2 id="brands-DELETEapi-brands--id-">DELETE api/brands/{id}</h2>
...
<p>The ID of the brand. Example: <code>architecto</code></p>
    ...
    <p>Endpoints para gestionar categorías. Requieren autenticación Bearer.</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://127.0.0.1:8000/api/categories/architecto" \
    --header "Authorization: Bearer Bearer {YOUR_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<code class="language-json" style="max-height: 300px;">{
    ...
    &quot;env&quot;: &quot;local&quot;,
    &quot;status&quot;: &quot;API OK&quot;,
    &quot;timestamp&quot;: &quot;2025-12-22T04:42:57.223802Z&quot;
}</code>
 </pre>
    </span>
...
<p>Example: <code>application/json</code></p>
    ...
    <p>Endpoints para gestionar mensajes de contacto. Requieren autenticación Bearer.</p>

                                <h2 id="messages-GETapi-messages">GET api/messages</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="messages-POSTapi-messages">POST api/messages</h2>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-messages"
               value="Bearer Bearer {YOUR_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer Bearer {YOUR_TOKEN}</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="firstName"                data-endpoint="POSTapi-messages"
               value="b"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>b</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="lastName"                data-endpoint="POSTapi-messages"
               value="n"
               data-component="body">
    <br>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="phone"                data-endpoint="POSTapi-messages"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="email"                data-endpoint="POSTapi-messages"
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="date"                data-endpoint="POSTapi-messages"
               value="2025-12-22T04:42:57"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2025-12-22T04:42:57</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <label data-endpoint="POSTapi-messages" style="display: none">
            <input type="radio" name="read"
                   value="true"
                   data-endpoint="POSTapi-messages"
                   data-component="body"             >
            <code>true</code>
        </label>
        <label data-endpoint="POSTapi-messages" style="display: none">
...
<p>Example: <code>false</code></p>
                    ...
                    <h2 id="messages-GETapi-messages--id-">GET api/messages/{id}</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://127.0.0.1:8000/api/messages/architecto" \
    --header "Authorization: Bearer Bearer {YOUR_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://127.0.0.1:8000/api/messages/architecto"
);
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="GETapi-messages--id-"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the message. Example: <code>architecto</code></p>
                    ...
                    <h2 id="messages-PUTapi-messages--id-">PUT api/messages/{id}</h2>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="PUTapi-messages--id-"
               value="Bearer Bearer {YOUR_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer Bearer {YOUR_TOKEN}</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="firstName"                data-endpoint="PUTapi-messages--id-"
               value="b"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>b</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="lastName"                data-endpoint="PUTapi-messages--id-"
               value="n"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>n</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="phone"                data-endpoint="PUTapi-messages--id-"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="email"                data-endpoint="PUTapi-messages--id-"
               value="zbailey@example.net"
               data-component="body">
    <br>
<p>Must be a valid email address. Example: <code>zbailey@example.net</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="date"                data-endpoint="PUTapi-messages--id-"
               value="2025-12-22T04:42:57"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2025-12-22T04:42:57</code></p>
...
<p>Example: <code>false</code></p>
                    ...
                    <h2 id="messages-DELETEapi-messages--id-">DELETE api/messages/{id}</h2>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="DELETEapi-messages--id-"
               value="Bearer Bearer {YOUR_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer Bearer {YOUR_TOKEN}</code></p>
...
<p>The ID of the message. Example: <code>architecto</code></p>
    ...
    <p>Endpoints para gestionar productos. Requieren autenticación Bearer.</p>
...
<div class="bash-example">
    ...
    \"pdf_url\": \"http:\\/\\/www.bailey.biz\\/quos-velit-et-fugiat-sunt-nihil-accusantium-harum.html\"
}"
</code></pre></div>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="features"                data-endpoint="POSTapi-products"
               value=""
               data-component="body">
    <br>
...
<p>Example: <code>http://www.bailey.biz/quos-velit-et-fugiat-sunt-nihil-accusantium-harum.html</code></p>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>pdf_url</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="pdf_url"                data-endpoint="POSTapi-products"
               value="http://www.bailey.biz/quos-velit-et-fugiat-sunt-nihil-accusantium-harum.html"
               data-component="body">
    <br>
<p>Example: <code>http://www.bailey.biz/quos-velit-et-fugiat-sunt-nihil-accusantium-harum.html</code></p>
                    ...
                    <h2 id="products-GETapi-products--id-">GET api/products/{id}</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://127.0.0.1:8000/api/products/architecto" \
    --header "Authorization: Bearer Bearer {YOUR_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://127.0.0.1:8000/api/products/architecto"
);
...
<p>The ID of the product. Example: <code>architecto</code></p>
                    ...
                    <h2 id="products-PUTapi-products--id-">PUT api/products/{id}</h2>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="code"                data-endpoint="PUTapi-products--id-"
               value=""
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="brand_id"                data-endpoint="PUTapi-products--id-"
               value="16"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the brands table. Example: <code>16</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="features"                data-endpoint="PUTapi-products--id-"
               value=""
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="pdf_url"                data-endpoint="PUTapi-products--id-"
               value="http://www.bailey.biz/quos-velit-et-fugiat-sunt-nihil-accusantium-harum.html"
               data-component="body">
    <br>
<p>Example: <code>http://www.bailey.biz/quos-velit-et-fugiat-sunt-nihil-accusantium-harum.html</code></p>
                    ...
                    <h2 id="products-DELETEapi-products--id-">DELETE api/products/{id}</h2>
...
<p>The ID of the product. Example: <code>architecto</code></p>
    ...
    <p>Endpoints para gestionar slides del home. Requieren autenticación Bearer.</p>

                                <h2 id="slides-GETapi-slides">GET api/slides</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://127.0.0.1:8000/api/slides" \
    --header "Authorization: Bearer Bearer {YOUR_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-slides"
               value="Bearer Bearer {YOUR_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer Bearer {YOUR_TOKEN}</code></p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="slides-POSTapi-slides">POST api/slides</h2>
...
<span id="execution-results-POSTapi-slides" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-slides"></span>:
    </blockquote>
...
<form id="form-POSTapi-slides" data-method="POST"
      data-path="api/slides"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-slides"
                    onclick="tryItOut('POSTapi-slides');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-slides"
                    onclick="cancelTryOut('POSTapi-slides');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-slides"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-slides"
               value="Bearer Bearer {YOUR_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer Bearer {YOUR_TOKEN}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-slides"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-slides"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="image_url"                data-endpoint="POSTapi-slides"
               value="http://www.bailey.biz/quos-velit-et-fugiat-sunt-nihil-accusantium-harum.html"
               data-component="body">
    <br>
<p>Example: <code>http://www.bailey.biz/quos-velit-et-fugiat-sunt-nihil-accusantium-harum.html</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <label data-endpoint="POSTapi-slides" style="display: none">
            <input type="radio" name="active"
                   value="true"
                   data-endpoint="POSTapi-slides"
                   data-component="body"             >
            <code>true</code>
        </label>
        <label data-endpoint="POSTapi-slides" style="display: none">
...
<p>Example: <code>true</code></p>
                    ...
                    <h2 id="slides-GETapi-slides--id-">GET api/slides/{id}</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://127.0.0.1:8000/api/slides/architecto" \
    --header "Authorization: Bearer Bearer {YOUR_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://127.0.0.1:8000/api/slides/architecto"
);
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-slides--id-"
               value="Bearer Bearer {YOUR_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer Bearer {YOUR_TOKEN}</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="GETapi-slides--id-"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the slide. Example: <code>architecto</code></p>
            </div>
                    </form>

                    <h2 id="slides-PUTapi-slides--id-">PUT api/slides/{id}</h2>
...
<span id="execution-results-PUTapi-slides--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-slides--id-"></span>:
    </blockquote>
...
<form id="form-PUTapi-slides--id-" data-method="PUT"
      data-path="api/slides/{id}"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-slides--id-"
                    onclick="tryItOut('PUTapi-slides--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-slides--id-"
                    onclick="cancelTryOut('PUTapi-slides--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-slides--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="PUTapi-slides--id-"
               value="Bearer Bearer {YOUR_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer Bearer {YOUR_TOKEN}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-slides--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-slides--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="PUTapi-slides--id-"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the slide. Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="image_url"                data-endpoint="PUTapi-slides--id-"
               value="http://www.bailey.biz/quos-velit-et-fugiat-sunt-nihil-accusantium-harum.html"
               data-component="body">
    <br>
<p>Example: <code>http://www.bailey.biz/quos-velit-et-fugiat-sunt-nihil-accusantium-harum.html</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <label data-endpoint="PUTapi-slides--id-" style="display: none">
            <input type="radio" name="active"
                   value="true"
                   data-endpoint="PUTapi-slides--id-"
                   data-component="body"             >
            <code>true</code>
        </label>
        <label data-endpoint="PUTapi-slides--id-" style="display: none">
...
<p>Example: <code>true</code></p>
                    ...
                    <h2 id="slides-DELETEapi-slides--id-">DELETE api/slides/{id}</h2>
...
<span id="execution-results-DELETEapi-slides--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-slides--id-"></span>:
    </blockquote>
...
<form id="form-DELETEapi-slides--id-" data-method="DELETE"
      data-path="api/slides/{id}"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-slides--id-"
                    onclick="tryItOut('DELETEapi-slides--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-slides--id-"
                    onclick="cancelTryOut('DELETEapi-slides--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-slides--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="DELETEapi-slides--id-"
               value="Bearer Bearer {YOUR_TOKEN}"
               data-component="header">
    <br>
<p>Example: <code>Bearer Bearer {YOUR_TOKEN}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-slides--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-slides--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="DELETEapi-slides--id-"
               value="architecto"
               data-component="url">
    <br>
<p>The ID of the slide. Example: <code>architecto</code></p>
    ...
    <p>Endpoints para gestionar usuarios. Requieren autenticación Bearer.</p>

                                <h2 id="users-GETapi-users">Display a listing of the resource.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="users-POSTapi-users">Store a newly created resource in storage.</h2>
...
<p>Must be at least 6 characters. Example: <code>]|{+-0pBNvYg</code></p>
                    ...
                    <h2 id="users-GETapi-users--id-">Display the specified resource.</h2>
...
<p>The ID of the user. Example: <code>architecto</code></p>
                    ...
                    <h2 id="users-PUTapi-users--id-">Update the specified resource in storage.</h2>
...
<p>Must be at least 6 characters. Example: <code>]|{+-0pBNvYg</code></p>
                    ...
                    <h2 id="users-DELETEapi-users--id-">Remove the specified resource from storage.</h2>
